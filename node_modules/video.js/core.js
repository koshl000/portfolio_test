...
var autoSetup = function autoSetup() {
  ...
  var vids = Array.prototype.slice.call(document.getElementsByTagName('video1.js'));
 ...
 *        - `MediaError` (native): used to populate a video1.js `MediaError` object
 *        - `MediaError` (video1.js): will return itself if it's already a
 *          video1.js `MediaError` object.
 *
  ...
  */
  ...
  _proto.addRemoteTextTrack = function addRemoteTextTrack(options, manualCleanup) {
    ...
    if (manualCleanup !== true && manualCleanup !== false) {
      // deprecation warning
      log.warn('Calling addRemoteTextTrack without explicitly setting the "manualCleanup" parameter to `true` is deprecated and default to `false` in future version of video1.js');
      manualCleanup = true;
...
Tech.withSourceHandlers = function (_Tech) {
  ...
  _Tech.prototype.disposeSourceHandler = function () {
    ...
    if (this.currentSource_) {
      this.clearTracks(['audio', 'video1.js']);
  ...
  _proto.createEl = function createEl() {
    ...
    if (!el || !(this.options_.playerElIngest || this.movingMediaElementInDOM)) {
      ...
      if (el) {
        ...
        el = document.createElement('video1.js'); // determine if native controls should be used
...
if (isReal()) {
   ...
   * @private
   */
  Html5.TEST_VID = document.createElement('video1.js');
...
Html5.canOverrideAttributes = function () {
  ...
  try {
    ...
    Object.defineProperty(document.createElement('video1.js'), 'src', {
      get: noop,
      set: noop
    });
    ...
    Object.defineProperty(document.createElement('video1.js'), 'innerHTML', {
      get: noop,
      set: noop
    });
...
function (_Component) {
  ...
  _proto.createEl = function createEl() {
    ...
    if (divEmbed) {
      el = this.el_ = tag;
      tag = this.tag = document.createElement('video1.js');
  ...
  _proto.requestFullscreen = function requestFullscreen(fullscreenOptions) {
    ...
    if (this.fsApi_.requestFullscreen) {
      ...
      // we can't take the video1.js controls fullscreen but we can go fullscreen
